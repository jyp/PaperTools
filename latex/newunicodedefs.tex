...
\begin{tikzpicture}[baseline={([yshift=-.5ex]current bounding box.center)},x=1ex,y=1ex,line width=.1ex]
...
\newcommand{\smalltriangleleft}{\mathbin{\text{\tikz [baseline={([yshift=-.5ex]current bounding box.center)},x=1ex,y=1ex,line width=.1ex] \draw (0,0.3) -- (-0.3,0) -- (0,-0.3) -- cycle;}}}
